...
///2b) Use a loop to iterate through the array again and concatenate all the names together, separated by spaces, and print the result to the console.
	...
	///3) How do you access the last element of any array?
	  //length property: which is subtracting 1 from the length of an array, which gives 
	//the index of the last element of an array using which the last element can be accessed.
...
///11) Write a method that takes two arrays of double and returns true if the average of the elements in the first array is greater than the average of the elements in the second array.
	...
	int ageOfVoter = 18;
	System.out.println("Is this person allowed to vote? " + isAllowed(ageOfVoter)); 	
	...
	///13)
			...
			public static boolean isAllowed(int ageOfVoter) {
				if (ageOfVoter > 18) {
					return true;
				} else {
					return false;
		...
		//The method solves the problem that ages 18 and older are allowed to vote, so it will print as a true statement
